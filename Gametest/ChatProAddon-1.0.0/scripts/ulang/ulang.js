...
It's author is @BIYUEHU,Copy or Steal and your mother must is dying,Wish person is well.
My github:https://github.com/BIYUEHU
My Blog:https://biyuehu.github.io
My Blog(for China):https://biyuehu.gitee.io
*/
...
export function chatf(message, target, name, color) {
    ...
    if (message != null && name == null && color == null) {
        cmd(`tellraw ${target} { \"rawtext\" : [ { \"text\" : \"${message}\" } ] }`);
    } else if (message != null && name != null && color == null) {
        cmd(`tellraw ${tagrget} { \"rawtext\" : [ { \"text\" : \"<${name}>${message}§r\" } ] }`);
    } else if (message != null && name == null && color != null) {
        cmd(`tellraw ${tagrget} { \"rawtext\" : [ { \"text\" : \"§${color1}${message}\" } ] }`);
    } else if (message != null && name != null && color !== null) {
        cmd(`tellraw ${tagrget} { \"rawtext\" : [ { \"text\" : \"<${name}>§${color1}${message}§r\" } ] }`);
    }
}
...
const blacklistJSON = {
    ...
    "blacklist": [
        {
            "wcpt": "苦力怕论坛",
            "wczxx": "klpbbs:https://klpbbs.com/?15490 MCBBS:XTS2005:https://www.mcbbs.net/?3727196 stonebig:https://www.mcbbs.net/?3831211 bilibili:stonebig:https://b23.tv/ot3daH QQ:3515135336",
            "wcwj": "外传BEic20.1.1~0.6.0,BEtic1.0.0+3*beta,BEgc4*beta，并在klpbbs,mcbbs,b站泄露密码,该事件影响不小"
        },
        {
            "wcpt": "QQ",
            "wczxx": "QQ:3515135336",
    ...
    "welcome": "欢迎检举，发现外传请及时向管理员举报，举报者会根据情况奖励1r~20r,但请勿想以此得利,举报会记录其时间,举报者信息等但不公开",
    "lasttime": "2021-07-15"
}
...
console.log('[HULI]ULANG By BIYUEHU');
