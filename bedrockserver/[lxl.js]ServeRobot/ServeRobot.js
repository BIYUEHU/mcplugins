const MainPath = "./plugins//serverobot/";
const version = "1.0.0";
...
function robot(pl, args) {
  ...
  if (_GET.slice(0, 1) == "#" && AI == true) {
    network.httpGet(
      "http://82.157.165.201/api/xiaoai.php?msg=" + _GET.slice(1) + "&n=text",
      (status, result) => {
        if (status == 200) {
    ...
    network.httpGet("https://api.iyk0.com/rili/", (status, result) => {
      if (status == 200) {
        ...
        back =
          robotname +
          textcolor +
          `北京时间:${NTO.Y}年${NTO.M}月${NTO.D}日 ${NTO.h}时${NTO.m}分${NTO.s}秒\n${NongLi}`;
      } else {
        back = robotname + textcolor + "失败";
      }
      chatf(back);
    ...
    network.httpGet(
      "https://api..com/x/web-interface/view?bvid=" + bv,
      (status, result) => {
        if (status == 200) {
    ...
    network.httpGet(
      "http://82.157.165.201/api/search.php?msg=" + nei,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "https://api.blackbe.xyz/api/check?v3=true&id=" + id,
      (status, result) => {
        if (status == 200) {
          json = JSON.parse(result);
          code = json.message;
    ...
    network.httpGet(
      "https://api.oddfar.com/yl/q.php?encode=text&c=2010",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "https://api.oddfar.com/yl/q.php?encode=text&c=1007",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/weather.php?msg=" + nei + "&type=1",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/fanyi2.php?msg=" + nei,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/yq.php?msg=" + nei,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/site.php?url=" + url,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/cs.php?url=" + url,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/ping.php?url=" + url,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "https://api.oddfar.com/yl/q.php?encode=text&c=1002",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "https://api.oddfar.com/yl/q.php?encode=text&c=1006",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "https://api.oddfar.com/yl/q.php?encode=text&c=1009",
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/laji.php?msg=" + nei,
      (status, result) => {
        if (status == 200) {
          back = robotname + textcolor + result;
        } else {
    ...
    network.httpGet(
      "http://82.157.165.201/api/motdpe.php?ip=" + ip + "&port=" + port,
      (status, result) => {
        if (status == 200) {
          json = JSON.parse(result);
          code = json.code;
