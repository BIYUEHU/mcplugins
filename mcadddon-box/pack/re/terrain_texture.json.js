...
ui.layout(
    <vertical padding="16">
        <horizontal>
            <text textColor="purple" textSize="18sp" layout_weight="1">编辑terrain_texture.json文件</text>
            <button id="save" text="保存" w="auto" style="Widget.AppCompat.Button.Borderless.Colored"/>
        </horizontal>
        <input id="content" h="*" gravity="top"/>
    </vertical>
);
var storage = storages.create("terrain_texture.json");
...
var lujing = "/sdcard/games/.byh.MCAddonBox/pack/re/textures/terrain_texture.json";
